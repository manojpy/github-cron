...
class BotConfig(BaseModel):
    ...
    OUTCOME_USE_MFE_METRIC: bool = Field(default=True) 
    OUTCOME_USE_MAE_METRIC: bool = Field(default=True) 
    OUTCOME_STOP_LOSS_PCT: float = Field(default=0.5, ge=0.0, le=5.0) 
    OUTCOME_TAKE_PROFIT_PCT: float = Field(default=0.3, ge=0.01, le=10.0) 
